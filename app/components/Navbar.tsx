      ...
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          >
            <Image
              ...
              draggable={false}
            />
            <h1 className="text-2xl font-bold bg-linear-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent font-(family-name:--font-montserrat) transition-all group-hover:from-purple-300 group-hover:to-blue-300">
              Mytherion
            </h1>
          </Link>
        </div>
        ...
        {!isInitialized ? (
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/projects"
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-purple-300 hover:text-purple-100 hover:bg-purple-500/10 rounded-lg transition-colors font-(family-name:--font-montserrat)"
            >
